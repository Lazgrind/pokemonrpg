...
export const MOVES = [
  ...
  { id: "guillotine", name: "Guillotine", type: "Normal", category: "physical", power: 0, accuracy: 30, pp: 5, effect: { kind: "ohko" } },
  ...
  { id: "horn-drill", name: "Horn Drill", type: "Normal", category: "physical", power: 0, accuracy: 30, pp: 5, effect: { kind: "ohko" } },
  ...
  { id: "sonic-boom", name: "Sonic Boom", type: "Normal", category: "special", power: 0, accuracy: 90, pp: 20, effect: { kind: "fixedDamage", amount: 20 } },
  { id: "disable", name: "Disable", type: "Normal", category: "status", power: 0, accuracy: 100, pp: 20, effect: { kind: "disable" } },
  ...
  { id: "mist", name: "Mist", type: "Ice", category: "status", power: 0, accuracy: 101, pp: 30, effect: { kind: "mist" } },
  ...
  { id: "low-kick", name: "Low Kick", type: "Fighting", category: "physical", power: 50, accuracy: 100, pp: 20, effect: { kind: "flinch", chance: 30 } },
  { id: "counter", name: "Counter", type: "Fighting", category: "physical", power: 0, accuracy: 100, pp: 20, priority: -5, effect: { kind: "counter" } },
  { id: "seismic-toss", name: "Seismic Toss", type: "Fighting", category: "physical", power: 0, accuracy: 100, pp: 20, effect: { kind: "levelDamage" } },
  { id: "strength", name: "Strength", type: "Normal", category: "physical", power: 80, accuracy: 100, pp: 15 },
  { id: "flash", name: "Flash", type: "Normal", category: "status", power: 0, accuracy: 70, pp: 20, effect: { kind: "statChange", target: "enemy", stat: "accuracy", stages: -1 } }, // HM05
  ...
  { id: "dragon-rage", name: "Dragon Rage", type: "Dragon", category: "special", power: 0, accuracy: 100, pp: 10, effect: { kind: "fixedDamage", amount: 40 } },
  ...
  { id: "fissure", name: "Fissure", type: "Ground", category: "physical", power: 0, accuracy: 30, pp: 5, effect: { kind: "ohko" } },
  ...
  { id: "teleport", name: "Teleport", type: "Psychic", category: "status", power: 0, accuracy: 101, pp: 20, priority: -6, effect: { kind: "escape" } },
  { id: "night-shade", name: "Night Shade", type: "Ghost", category: "special", power: 0, accuracy: 100, pp: 15, effect: { kind: "levelDamage" } },
  ...
  { id: "haze", name: "Haze", type: "Ice", category: "status", power: 0, accuracy: 101, pp: 30, effect: { kind: "haze" } },
  ...
  { id: "metronome", name: "Metronome", type: "Normal", category: "status", power: 0, accuracy: 101, pp: 10, effect: { kind: "metronome" } },
  ...
  { id: "conversion", name: "Conversion", type: "Normal", category: "status", power: 0, accuracy: 101, pp: 30, effect: { kind: "conversion" } },
  ...
  // Chybějící Gen 1 tahy doplněné kvůli TM systému (v0.93.0), ať existuje všech 50 TM.
  { id: "razor-wind", name: "Razor Wind", type: "Normal", category: "special", power: 80, accuracy: 100, pp: 10, effect: { kind: "twoTurn" } },
  { id: "egg-bomb", name: "Egg Bomb", type: "Normal", category: "physical", power: 100, accuracy: 75, pp: 10 },
  { id: "psywave", name: "Psywave", type: "Psychic", category: "special", power: 55, accuracy: 100, pp: 15 }, // Gen 1: variabilní damage; engine nemá → pevný power 55 (aproximace).
  { id: "bide", name: "Bide", type: "Normal", category: "physical", power: 0, accuracy: 101, pp: 10, effect: { kind: "bide" } }, // sbírá poškození 2 kola, pak vrátí ×2 (řeší useMove přes volatile.biding).
  ...
  { id: "dive", name: "Dive", type: "Water", category: "physical", power: 80, accuracy: 100, pp: 10, effect: { kind: "twoTurn" } },
  ...
  { id: "fly", name: "Fly", type: "Flying", category: "physical", power: 90, accuracy: 95, pp: 15, effect: { kind: "twoTurn" } },
