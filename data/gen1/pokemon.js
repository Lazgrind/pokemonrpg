/**
 * DATA: druhy Pokémonů generace 1 (Kanto, Pokédex 1–151).
 *
 * Odděleno od gen 2, aby šlo obě generace vyvíjet a opravovat NEZÁVISLE –
 * práce na gen 2 (./gen2.js) se tohoto souboru nikdy nedotkne (0 merge konfliktů).
 * Formát jednoho záznamu a popis polí (typedef Species) viz aggregator ../pokemon.js.
 */

/** @type {import("../pokemon.js").Species[]} */
export const SPECIES_GEN1 = [
  {
    id: "bulbasaur",
    dexNo: 1,
    name: "Bulbasaur",
